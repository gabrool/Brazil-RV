...
def download_isin_database(
    ...
    *,
    ...
    return _download_reference_dataset_for_date(
        repo_root,
        dataset_id="b3_isin_database",
        ref_date=ref_date,
        client=client,
        holidays=holidays,
    )
...
def download_trading_parameters_for_date(
    repo_root: Path,
    *,
    ref_date: date,
    client: HttpClient | None = None,
    ...
    return _download_reference_dataset_for_date(
        repo_root,
        dataset_id="b3_trading_parameters",
        ref_date=ref_date,
        client=client,
        holidays=holidays,
    )
...
def download_derivatives_reference_prices_for_date(
    repo_root: Path,
    *,
    ref_date: date,
    client: HttpClient | None = None,
    ...
    return _download_reference_dataset_for_date(
        repo_root,
        dataset_id="b3_derivatives_reference_prices",
        ref_date=ref_date,
        client=client,
        holidays=holidays,
    )
...
def _download_reference_dataset_for_date(
    repo_root: Path,
    *,
    dataset_id: str,
    ref_date: date,
